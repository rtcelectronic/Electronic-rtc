document.addEventListener("DOMContentLoaded", function() {
    ...
    // --- ส่วนที่ 1: Slideshow อัตโนมัติ ---

    // รายการรูปภาพที่คุณต้องการให้แสดง (ใส่ URL รูปภาพของคุณที่นี่)
    const images = [
        "/Test/All/สมัคร.jpg",
        "/All/images/กล่องข่าวสาร/สมัคร.jpg",
    ...
    if (slideshowImage) { // <<<< เพิ่มการตรวจสอบ Element
    ...
    //-----------------------------------------------------------//
    // --- ส่วนที่ 2: การจัดการหน้าเว็บแบบไดนามิก ---
    ...
    const loadPage = async (pageName) => {
        if (!pageContainer) return; // ออกหากไม่พบ container
    ...
    //-----------------------------------------------------------//
    // --- ส่วนที่ 3: อัปเดต Card โปรโมชั่น ---
    ...
    // ตรวจสอบว่า Element หลักของ Card พร้อมใช้งาน
    if (card) {
