...
const newsData = [
    {
        ...
        imageUrl: "images/สไลด์ข่าวสาร/ผอ.jpg",
    ...
    newsData.forEach(news => {
        ...
        <article class="news-card">
            <div class="news-image-container">
                <img src="${news.imageUrl}" alt="${news.altText}" loading="lazy" onerror="this.src='httpsias://placehold.co/600x400/cccccc/FFFFFF?text=Image+Error'; this.alt='Image failed to load';">
            </div>
...
// (เนื่องจากเราใช้ 'defer' ในแท็ก <script> ที่ HTML)
// DOMContentLoaded จึงไม่จำเป็นต้องใช้อีกต่อไป
// สคริปต์จะรันเองหลังจาก HTML พร้อมใช้งาน
renderNews();
