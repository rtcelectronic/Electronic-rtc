document.addEventListener('DOMContentLoaded', function() { // <<<< ห่อหุ้มโค้ดทั้งหมด
    ...
    if (!imgEl || !titleEl || !descEl) {
        console.error("Slider elements (myImage, myTitle, or myDesc) not found. Skipping slider initialization.");
        return; 
    }
    ...
    // ประกาศเป็น Global เพื่อให้เรียกใช้จาก HTML ได้ (เช่น <button onclick="changeSlide(1)">)
